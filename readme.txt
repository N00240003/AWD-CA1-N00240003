...
//Intro
In CA2 I have expanded my original Laravel project that only had one model (Artpieces) by adding two more: Artists and Essays. Guided by the CA lessons, I learned how to build both one-to-many and many-to-many relationships and implemented almost full CRUD functionality across all three models.
